...
$tituloE[9] = "REPORTE PROXIMOS A VENCER";
...
$subtituloE[9] = "ORFEO - Fecha: " . date("Y/m/d H:i:s"). "\n Parametros de Fecha: Entre $fecha_ini y $fecha_fin";
//$subtituloE[8] = "ORFEO - Fecha: " . date("Y/m/d H:i:s"). "\n Parametros de Fecha: Entre $fecha_ini y $fecha_fin";
...
$helpE[9] = "Este reporte muestra los documentos que estan proximos a vencer. ";
...
if($tipoEstadistica!=7 && $tipoEstadistica!=19 && $tipoEstadistica!=23 && $tipoEstadistica!=24 && $tipoEstadistica!=25 && $tipoEstadistica!=26){
?>
</label>
</td>
</tr>
...
if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or
		...
		$tipoEstadistica==12 or $tipoEstadistica==17  or $tipoEstadistica==18 or $tipoEstadistica==20 or $tipoEstadistica==26 )
{
	?>
		<tr>
