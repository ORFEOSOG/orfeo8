...
*/
$x=0;
include "./TxFormulario1.php";

if ($pasa=='1')
{
    $datosEnvio = "&rad=$rad";
    header ("Location: ./dat_peticionario1.php?$datosEnvio"); "";
}
?>
...
<title> .:Generador Certificación Zonas Seguras:. </title>
</head>
 ...
 <div class="demo form-bg">
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col-lg-12">
                    <h1 class="heading"> Generador Certificación Zonas Seguras </h1>
	    ...
	    <p>	
            ...
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    <form action="./certificadoindex.php" method="post">
