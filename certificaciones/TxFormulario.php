...
if(!empty($rad))
{
	$sql= "select r.radi_nume_radi from radicado r inner join sgd_dir_drecciones d on d.radi_nume_radi='$rad' where d.radi_nume_radi = r.radi_nume_radi and d.sgd_dir_doc='$cod'";
	$rsql=$db->query($sql);
