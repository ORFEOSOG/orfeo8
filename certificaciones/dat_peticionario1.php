...
$sql1="select sgd_dir_nomremdes as Nombre, sgd_dir_doc as Cedula, sgd_dir_direccion as Direccion,sgd_dir_telefono as Telefono, sgd_dir_mail as email from radicado r inner join sgd_dir_drecciones d on d.radi_nume_radi= '$rad'  where r.radi_nume_radi=d.radi_nume_radi";
$Rsql1=$db->query($sql1);

$Nombre=$_SESSION['Nombre']=$Rsql1->fields["NOMBRE"];
$Cedula=$_SESSION['Cedula']=$Rsql1->fields["CEDULA"];
$Direccion=$_SESSION['Direccion']=$Rsql1->fields["DIRECCION"];
$Telefono=$_SESSION['Telefono']=$Rsql1->fields["TELEFONO"];
$Email=$_SESSION['Email']=$Rsql1->fields["EMAIL"];
?>
