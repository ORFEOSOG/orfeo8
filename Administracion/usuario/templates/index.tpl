	...
	<div class="padding-10">
		...
		<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
			...
			<div>
				...
				<div class="widget-body no-padding smart-form">
                    <label class="select">
                        <select data-tipo="dependencias"  id="grupo_dependencias" name="grupo"
                                class="custom-scroll">
                            <option value="">-- Seleccione una Dependencia --</option>
                            <-{foreach item=i from=$dependencias}->
                                <option value="<-{$i.DEPE_CODI}->"> <-{$i.DEPE_NOMB}-> </option>
                            <-{/foreach}->
                        </select>
                    </label>
					<div class="widget-body-toolbar"></div>
        ...
        <td class="hasinput">
                        <label class="select">
                                <select class="custom-scrollselectpicker" name="nivel">
                                        <option value="">-- Seleccione nivel de seguridad --</option>
