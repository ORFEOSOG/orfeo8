...
$sql1 = "
select distinct (su.sgd_sbrd_descrip||'-'||su.sgd_sbrd_codigo) AS DETALLE, su.sgd_id_subserie AS CODIGO_SUBSERIE 
from sgd_mrd_matrird m,
sgd_sbrd_subserierd su
where cast(m.sgd_mrd_esta as numeric(1)) = 1 and m.sgd_id_serie = $selectSerie 
and su.sgd_id_serie = $selectSerie 
and su.sgd_id_subserie = m.sgd_id_subserie
";
...
cast(m.sgd_mrd_esta as numeric(1)) = 1 and
m.sgd_srd_codigo = $selectSerie and 
m.sgd_id_subserie =  $selectSubSerie and 
t.sgd_tpr_codigo = m.sgd_tpr_codigo and 
sb.sgd_id_subserie = m.sgd_id_subserie and
sb.sgd_srd_codigo = m.sgd_srd_codigo and 
t.sgd_tpr_estado = 1 and 
sgd_tpr_tp1 >= 1 
order by detalle
